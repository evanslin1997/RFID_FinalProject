...
namespace WindowsFormsApplication6
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            string myConnStr = "server=localhost;database=rfid_test_db;uid=root;pwd=*UHB7ygv6tfc;";
            ...
            InitializeComponent();
            MySqlCommand command = new MySqlCommand("select d.id as d_id, d.item_name as item_name from asset_relationship as a inner join employee as e on a.owner_id = e.id inner join device d on d.id = a.device_id where e.id = \"00950902FC193749E9CB436E484F7B81\"; ");

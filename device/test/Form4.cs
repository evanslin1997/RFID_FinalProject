    ...
    public partial class Form2 : Form
    {
        ...
        public Form2(String d_id)
        {
            ...
            try
            {
                ...
                MySqlCommand query_owner_name_command = new MySqlCommand("select item_name, (select e.name from employee as e where e.id = d.owner_id) as owner_name, (select e.name from employee as e where e.id = d.user_id) as user_name, is_return, lend_date, return_date from device as d where d.id =\"" + d_id + "\"; ");
